"""MFL wrappers around canonical normalizers."""
...
def normalize_matchup_data(df, league_id: str | None = None):
    return normalize_matchup_df(df, platform="mfl", league_id=league_id)


def normalize_roster_data(df, league_id: str | None = None):
    return normalize_roster_df(df, platform="mfl", league_id=league_id)


def normalize_draft_data(df, league_id: str | None = None):
    return normalize_draft_df(df, platform="mfl", league_id=league_id)


def normalize_transaction_data(df, league_id: str | None = None):
    return normalize_transaction_df(df, platform="mfl", league_id=league_id)


def normalize_schedule_data(df, league_id: str | None = None):
    return normalize_schedule_df(df, platform="mfl", league_id=league_id)
